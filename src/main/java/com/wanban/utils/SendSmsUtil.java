 ...
 * @Description:发送验证码
 * @author:Alex
 * @Date 2018年 2月5日 下午10:03:04
 */
public class SendSmsUtil {
    private static final String QUERY_PATH="https://api.miaodiyun.com/20150822/industrySMS/sendSMS";
    private static final String ACCOUNT_SID="2c4403b14a43437786f3ae09fcf7244e";
    private static final String AUTH_TOKEN="58424b77d5d14559a6b3e9a735e4eb83";
    ...
    public static String getCode(String phone){
        ...
        String tamp="【玩伴科技】尊敬的用户，您的验证码为"+rod;
